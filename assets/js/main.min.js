...
function dt_custom_view(e, t, a, i) {
	...
	do_filter_active(n) != n && e!="custom_tasks" && (e = ""), $('input[name="' + n + '"]').val(e), $(t).DataTable().ajax.reload();
	...
	if(n.includes("task_assigned_") || n.includes("task_tasktype_") || cur_val == '' || cur_val == 'task_status_1' || cur_val == 'task_status_2' || cur_val == 'task_status_3' || cur_val == 'task_status_4' || cur_val == 'task_status_5' || req_task != '' || req_task_type!='' || req_task_assign!=''){
...
function init_kanban(e, t, a, i, n, s) {
	if (0 !== $("#kan-ban").length) {
		...
		var r = $('input[name="sort_type"]'),
			...
			if(r.length ==0){
				var r = $('select[name="sort_type"]'),
				c = $('select[name="sort"]').val();
			}
...
function init_deal_model(query) {
	
	
	$.ajax({url: admin_url+"projects/project?"+query, success: function(result){
		$("#newDealModalContent").html(result);
		init_tags_inputs(); init_selectpicker(); init_form_reminder(); init_datepicker(); init_color_pickers();
