  ...
  <?php foreach(tasks_summary_data((isset($rel_id) ? $rel_id : null),(isset($rel_type) ? $rel_type : 'project')) as $summary){ ?>
    <div class="col-md-2 col-xs-6 border-right">     
      <p class="font-medium no-mbot">
        <a style="color:<?php echo $summary['color']; ?>" href="#" id="task_status_<?php echo $summary['status_id']; ?>" data-cview="task_status_<?php echo $summary['status_id']; ?>" onclick="dt_custom_view('task_status_<?php echo $summary['status_id']; ?>','<?php echo $view_table_name; ?>','task_status_<?php echo $summary['status_id']; ?>'); return false;"><?php echo $summary['name']; echo " - ";?><?php echo $summary['total_tasks']; ?></a> 
      </p>
