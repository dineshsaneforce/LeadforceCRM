                            ...
                            <table class="table dt-table scroll-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= admin_url('integration/sms/deleteTemplate/'.$template->id) ?>" class="btn text-danger delete_link"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                        </table>
...
<div class="modal" id="templateModal" style="display: none;">
    <div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open(admin_url('integration/sms/saveTemplate'),array('id'=>'templateForm'));?>
