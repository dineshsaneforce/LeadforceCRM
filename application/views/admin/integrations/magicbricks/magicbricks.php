                                ...
                                <tbody>
                                    <?php if ($configs) : foreach ($configs as $key => $config) : ?>
                                            <tr>
                                                ...
                                                <td><a data-toggle="modal" data-target="#configModal" href="<?php echo admin_url('integration/magicbricks/config/' . $config->id) ?>" class="">View</a> | <a class="text-danger" href="<?php echo admin_url('integration/magicbricks/deleteconfig/' . $config->id) ?>" class="">Delete</a></td>
                                            </tr>
                                    <?php endforeach;
                                    endif; ?>
                                </tbody>
...
<div class="modal" id="connectFormModal" style="display: none; z-index: 1050;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo admin_url('integration/magicbricks') ?>" method="POST">
                <div class="modal-header">
