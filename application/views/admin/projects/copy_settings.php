                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group select-placeholder contactsdiv1" style="margin-bottom:0px;">
                            <label for="project_contacts_selectpicker" class="control-label"><small class="req text-danger">* </small><?php echo _l('project_contacts'); ?></label>
                            <div class="input-group input-group-select " style="margin-bottom:10px;">
                                ...
                                <div class="input-group-addon" style="opacity: 1;"><a href="#" data-toggle="modal" data-target="#project_contacts_modal1"><i class="fa fa-plus"></i></a></div>
                            </div>
                        </div>
                        ...
                        <div class='row primarydiv1'>
                            <div class="col-md-12">
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="primary_contact1" id="primary_contact1" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        <option></option>
                                        <?php
                        ...
                        <div class='row'>
                            <div class="col-md-12 form_status">
                                <div class="form-group select-placeholder">
                                    ...
                                    <div class="clearfix"></div>
                                    <select name="status1" id="status1" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-none-selected-text="Nothing selected">
                                        <option></option>
                                        <?php foreach ($statuses as $status) { ?>
