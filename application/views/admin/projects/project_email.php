...
<?php
$emails =$this->projects_model->get_emails($project->id);
?>
...
if(get_option('connect_mail')=='no'){
	$this->load->view("admin/outlook/outlook_replyjs");
}else{
	$this->load->view("admin/staff/imap_replyjs");
} ?>
