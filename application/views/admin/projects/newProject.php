...
<div class="row">
    ...
    <div class="col-md-12">
                    ...
                    <div class="form-group select-placeholder clientiddiv form-group-select-input-groups_in[] input-group-select">
                        ...
                        <label for="clientid" class="control-label"><?php echo _l('project_customer'); ?>
                            <?php if (!empty($important_fields) && in_array("clientid", $important_fields)) { ?>
                                <span style="color: #d2be19;margin-left: 5px;" title="<?php if (!empty($important_messages->clientid)) {
                                                                                            echo $important_messages->clientid;
                                                                                        } ?>" class="pull-right"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>
                                    <?php } ?>
                        </label>
                ...
                <?php }
                if (!empty($need_fields) && in_array("project_contacts[]", $need_fields)) { ?>
                    <div class="form-group select-placeholder contactsdiv">
                        <label for="project_contacts_selectpicker" class="control-label"><?php if (!empty($need_fields) && in_array("project_contacts[]", $need_fields) && !empty($mandatory_fields) && in_array("project_contacts[]", $mandatory_fields)) { ?> <small class="req text-danger">* </small><?php } ?><?php echo _l('project_contacts'); ?>
                                <?php if (!empty($important_fields) && in_array("project_contacts[]", $important_fields)) { ?>
                                    <span style="color: #d2be19;margin-left: 5px;" title="<?php if (!empty($important_messages->project_contacts)) {
                                                                                                echo $important_messages->project_contacts;
                                                                                            } ?>" class="pull-right"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>
                                        <?php } ?>
                        </label>
                        <div class="input-group input-group-select ">
                          ...
                          foreach($client_contacts as $cckey => $ccval){ 
                            ...
                            <div class="input-group-addon" style="opacity: 1;"><a href="#" data-toggle="modal" data-target="#project_contacts_modal"><i class="fa fa-plus"></i></a></div>
                        </div>
                    </div>
                <?php }
                if (!empty($need_fields) && in_array("primary_contact", $need_fields)) { ?>
                            ...
                            <div class="form-group select-placeholder">
                                <label for="status"><?php if (!empty($need_fields) && in_array("primary_contact", $need_fields) && !empty($mandatory_fields) && in_array("primary_contact", $mandatory_fields)) { ?> <small class="req text-danger">* </small><?php } ?><?php echo _l('project_primary_contacts'); ?>
                                        <?php if (!empty($important_fields) && in_array("primary_contact", $important_fields)) { ?>
                                            <span style="color: #d2be19;margin-left: 5px;" title="<?php if (!empty($important_messages->primary_contact)) {
                                                                                                        echo $important_messages->primary_contact;
                                                                                                    } ?>" class="pull-right"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>
                                                <?php } ?>
                                </label>
                                    ...
                                    <label for="status"><?php if (!empty($need_fields) && in_array("status", $need_fields) && !empty($mandatory_fields) && in_array("status", $mandatory_fields)) { ?> <small class="req text-danger">* </small><?php } ?><?php echo _l('project_status'); ?>
                                            <?php if (!empty($important_fields) && in_array("status", $important_fields)) { ?>
                                                <span style="color: #d2be19;margin-left: 5px;" title="<?php if (!empty($important_messages->status)) {
                                                                                                            echo $important_messages->status;
                                                                                                        } ?>" class="pull-right"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>
                                                    <?php } ?>
                                    </label>
                                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group select-placeholder">
                                ...
                                <select name="billing_type" class="selectpicker" id="billing_type" data-width="100%" <?php echo $disable_type_edit; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    ...
                                    <option value="3" data-subtext="<?php echo _l('project_billing_type_project_task_hours_hourly_rate'); ?>" <?php if (isset($project) && $project->billing_type == 3 || !isset($project) && $auto_select_billing_type && $auto_select_billing_type->billing_type == 3) {
                                                                                                                                                    echo 'selected';
                ...
                <?php }
                if (isset($project) && project_has_recurring_tasks($project->id)) { ?>
                ...
                <?php if (isset($project)) { ?>
                    ...
                    <input type="hidden" name="notify_project_members_status_change" id="notify_project_members_status_change" value="1">
                <?php } ?>
                <!--  
                         -->
                ...
                <div class="form-group showproducts">
                    ...
                    <div class="col-md-8 text-right" style="padding-top:30px"><b>Total</b></div>
                    <div class="col-md-3 text-right" style="padding-top:30px"><b><span id="grandtotal">0</span></b></div>
                </div>
                <?php
                ...
                <div class="row">
                    ...
                    <?php }
                    if (!empty($need_fields) && in_array("project_deadline", $need_fields)) { ?>
                ...
                <?php }
                if (!empty($need_fields) && in_array("tags", $need_fields)) { ?>
                    <div class="form-group" id="ch_tag">
                        <label for="tags" class="control-label"><i class="fa fa-tag" aria-hidden="true"></i>
                            <?php echo _l('tags'); ?>
                            <?php if (!empty($important_fields) && in_array("tags", $important_fields)) { ?>
                                <span style="color: #d2be19;margin-left: 5px;" title="<?php if (!empty($important_messages->tags)) {
                                                                                            echo $important_messages->tags;
                                                                                        } ?>" class="pull-right"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>
                                    <?php } ?>
                        </label>
                        <input type="text" class="tagsinput" id="tags" name="tags" value="<?php echo (isset($project) ? prep_tags_input(get_tags_in($project->id, 'project')) : ''); ?>" data-role="tagsinput" onchange="ch_tags(this)">
                    </div>
                ...
                <?php if (!empty($need_fields) && in_array("description", $need_fields)) { ?>
                    <p class="bold"><?php if (!empty($need_fields) && in_array("description", $need_fields) && !empty($mandatory_fields) && in_array("description", $mandatory_fields)) { ?> <small class="req text-danger">* </small><?php } ?><?php echo _l('project_description'); ?>
                            <?php if (!empty($important_fields) && in_array("description", $important_fields)) { ?>
                                <span style="color: #d2be19;margin-left: 5px;margin-right:85%" title="<?php if (!empty($important_messages->description)) {
                                                                                                            echo $important_messages->description;
                                                                                                        } ?>" class="pull-right"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>
                                    <?php } ?>
                    </p>
                    <?php $contents = '';
